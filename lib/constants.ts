...
export const ROUTES = {
  ...
  legalCookie: "/legal/cookie",
  legalKvkk: "/legal/kvkk",
  legalDistanceSales: "/legal/distance-sales-agreement",
  legalPreliminaryInformation: "/legal/preliminary-information-form",
  legalRefundCancellation: "/legal/refund-cancellation",
  contact: "/contact",
  login: "/login",
  register: "/register",
