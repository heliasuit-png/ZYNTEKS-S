...
export const tr: Dictionary = {
  ...
  landing: {
    ...
    pricing: {
      ...
      desc: "Zynteksis ile production-ready gözlemlenebilirliği ölçekleyin.",
      startFree: "Ücretsiz Başla",
      viewAllPlans: "Tüm planları gör",
      contactSales: "Satışla iletişime geç",
      pageTitle: "İhtiyacınıza uygun planı seçin",
      pageDesc:
      ...
      plans: {
        free: {
          ...
          features: [
            ...
            "Uptime monitoring",
            "Error tracking",
            "Temel latency / response-time takibi",
            "Temel dashboard",
            "Sınırlı alert",
            "Temel status page",
            "Sınırlı AI analysis",
            "Kendi API key'ini bağlama",
            "Temel raporlar",
          ],
        },
        developer: {
          ...
          features: [
            ...
            "Temel alerting",
            "Status page",
            "Gelişmiş hata detayları",
            "AI destekli error analysis",
            "AI code analysis",
